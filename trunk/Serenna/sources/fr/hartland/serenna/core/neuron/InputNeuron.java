...
/**
 * Provide specific behavior components for input neurons as compared to typical neurons (linear activation function,
 * visible ability to set its input value, etc.)
 * 
